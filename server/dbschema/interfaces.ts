...
export interface Asset extends std.$Object {
  "cost": number;
  "liquid": boolean;
  "name": string;
  "owned": boolean;
  "price": number;
  "sold": {price: number, amount: number}[];
  "spendable": boolean;
  "amount": number;
  "account": Account;
}
export interface Card extends Asset {
  "error": boolean;
  "grade"?: number | null;
  "graded": boolean;
  "number"?: string | null;
...
export interface CardSet extends Item {}
export interface Cash extends Asset {
  "frequency": number;
  "interest": number;
}
export interface Condition extends Item {}
export interface Crypto extends Asset {
  "blockchain": string;
  "symbol": string;
}
export interface Edition extends Item {}
export interface GradingCompany extends Item {
  "longName": string;
}
export interface Language extends Item {}
export interface Payment extends std.$Object {
  "asset": Asset;
  "amount": number;
